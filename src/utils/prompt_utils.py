from .LLM_utils import build_message, Message, Role, TokenLimit
...
def generate_multi_chapters_example_messages_for_16k(lang: str) -> list[Message]:
    ...
    user_message = build_message(
        Role.USER, _GENERATE_MULTI_CHAPTERS_USER_MESSAGE_FOR_16K
    )  # nopep8.
    assistant_message = build_message(
        Role.ASSISTANT, _GENERATE_MULTI_CHAPTERS_ASSISTANT_MESSAGE_FOR_16K
    )  # nopep8.
